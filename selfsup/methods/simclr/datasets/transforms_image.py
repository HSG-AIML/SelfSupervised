...
############### Kornia Gaussian Blur ###############
####################################################
class GaussianBlur2dKornia(nn.Module):
    ...
    def __init__(self, kernel_size: Tuple[int, int],
        ...
        super(GaussianBlur2dKornia, self).__init__()
...
def gaussian_blur2d(
    ...
    """
    return GaussianBlur2dKornia(kernel_size, sigma, border_type)(input)
